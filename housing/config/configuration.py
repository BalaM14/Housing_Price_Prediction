...
class Configuration:
    ...
    def get_model_trainer_config(self) -> ModelTrainingConfig:
        try:
            ...
            trained_model_file_path = os.path.join(model_trainer_artifact_dir,model_trainer_info[MODEL_TRAINER_TRAINED_MODEL_DIR_KEY],model_trainer_info[MODEL_TRAINER_MODEL_FILE_NAME_KEY])
            model_config_file_path=os.path.join(model_trainer_info[MODEL_TRAINER_MODEL_CONFIG_DIR_KEY],model_trainer_info[MODEL_TRAINER_MODEL_CONFIG_FILE_NAME_KEY])
